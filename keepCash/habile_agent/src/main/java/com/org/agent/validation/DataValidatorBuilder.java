 ...
 * under the License.
 */
package com.org.agent.validation;
...
*/
    ...
    public DataValidatorBuilder minAndMaxLengthOfString(final Integer minLength, final Integer maxLength) {
        if (this.value == null && this.ignoreNullValue) { return this; }
        ...
        if (this.value != null && this.value.toString().trim().length() > maxLength) {
            ...
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(),
                    defaultEnglishMessage.toString(), this.parameter, maxLength, this.value.toString());
            this.dataValidationErrors.add(error);
        }else if(this.value != null && this.value.toString().trim().length() < minLength) {
        	final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                    .append(this.parameter).append(".less.than.min.length");
            final StringBuilder defaultEnglishMessage = new StringBuilder("The parameter ").append(this.parameter)
                    .append(" less than length of ").append(minLength).append(".");
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(),
    ...
    public DataValidatorBuilder futureDateValidation(final LocalDate localDate) {
        if (this.value == null && this.ignoreNullValue) { return this; }
        ...
        if (localDate.isAfter(new LocalDate())) {
            final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                    .append(this.parameter).append(".in.future.date");
            final StringBuilder defaultEnglishMessage = new StringBuilder("The parameter ").append(this.parameter)
                    .append(" is in future ").append(".");
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(),
    ...
    public DataValidatorBuilder validateEmailAddress(final String string) {
        if (this.value == null && this.ignoreNullValue) { return this; }
        ...
        if (!matcher.matches()) {
            final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                    .append(this.parameter).append(".invalid.email.address");
            final StringBuilder defaultEnglishMessage = new StringBuilder("The parameter ").append(this.parameter)
                    .append(" Invalid Email Address ").append(".");
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(),
                    defaultEnglishMessage.toString(), this.parameter, this.value.toString());
            this.dataValidationErrors.add(error);
        }
    ...
    public DataValidatorBuilder longNotEqualToOneAndThree() {
        if (this.value == null && this.ignoreNullValue) { return this; }
        ...
        if (this.value != null) {
            ...
            if ((number != 1) || (number !=3) ) {
                final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                        .append(this.parameter).append(".not.equal.to.one.or.three");
                final StringBuilder defaultEnglishMessage = new StringBuilder("The parameter ").append(this.parameter).append(
                        " must be 1 or 3.");
                ApiParameterError error=null;
                if(number==1)
                {
                error = ApiParameterError.parameterError(validationErrorCode.toString(),
                        defaultEnglishMessage.toString(), this.parameter, number, 1 );
                }
                if(number==3)
                {
                error = ApiParameterError.parameterError(validationErrorCode.toString(),
                            defaultEnglishMessage.toString(), this.parameter, number, 3 );	
                }
                this.dataValidationErrors.add(error);
            }
        }
    ...
    public DataValidatorBuilder alphaNumericString(final String string) {
        if (this.value == null && this.ignoreNullValue) { return this; }
        ...
        if (!matcher.matches()) {
            final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                    .append(this.parameter).append(".contains.non.alpha.numeric.values");
            final StringBuilder defaultEnglishMessage = new StringBuilder("The parameter ").append(this.parameter)
                    .append(" Contains non alphanumeric values ").append(".");
            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(),
                    defaultEnglishMessage.toString(), this.parameter, this.value.toString());
            this.dataValidationErrors.add(error);
        }
