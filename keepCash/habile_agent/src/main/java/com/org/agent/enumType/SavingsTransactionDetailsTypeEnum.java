package com.org.agent.enumType;
...
public enum SavingsTransactionDetailsTypeEnum {
	...
	ODWITHTRAWAL(60, "SavingsTransactionDetailsTypeEnum.odWithtrawal"),
    ...
    public static SavingsTransactionDetailsTypeEnum fromInt(final Integer transactionType) {
        ...
        switch (transactionType) {
            ...
            break;
            case 60:
                savingsAccountTransactionType = SavingsTransactionDetailsTypeEnum.ODWITHTRAWAL;
            break;
    ...
    public boolean isOdWithtrawal() {
        return this.value.equals(SavingsTransactionDetailsTypeEnum.ODWITHTRAWAL.getValue());
    }
