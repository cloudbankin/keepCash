...
import com.org.agent.core.Base64EncodedImage;
import com.org.agent.core.StorageType;
import com.org.agent.core.service.ThreadLocalContextUtil;
import com.org.agent.data.DocumentManagementData;
import com.org.agent.data.FileData;
import com.org.agent.data.ImageData;
import com.org.agent.exception.ContentManagementException;
...
public class FileSystemContentRepository implements ContentRepository {
    ...
    @Override
    public FileData fetchFile(final DocumentManagementData documentData) {
    ...
    private String generateFileParentDirectory(final String entityType, final Long entityId) {
        return FileSystemContentRepository.FINERACT_BASE_DIR + File.separator
        		+"default" + File.separator + "documents" + File.separator
