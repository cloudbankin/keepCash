...
import com.org.agent.exception.DocumentNotFoundException;
...
public class S3ContentRepository implements ContentRepository {
    ...
    @Override
    public FileData fetchFile(final DocumentManagementData documentData) throws DocumentNotFoundException {
