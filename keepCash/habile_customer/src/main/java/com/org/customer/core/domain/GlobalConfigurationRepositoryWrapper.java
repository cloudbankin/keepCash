 ...
 * under the License.
 */
package com.org.customer.core.domain;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import com.org.customer.exception.GlobalConfigurationPropertyNotFoundException;
...
public class GlobalConfigurationRepositoryWrapper {
    ...
    public GlobalConfigurationProperty findOneWithNotFoundDetection(final Long configId) {
        final GlobalConfigurationProperty property = this.repository.findById(configId).get();
