 ...
 * under the License.
 */
package com.org.customer.command;
...
public class CommandProcessingResult implements Serializable {
    ...
    public CommandProcessingResult(final Long resourceId, final Long officeId, final Long commandId, final Map<String, Object> changesOnly) {
        if (resourceId != null) {
    ...
    public boolean isRollbackTransaction() {
