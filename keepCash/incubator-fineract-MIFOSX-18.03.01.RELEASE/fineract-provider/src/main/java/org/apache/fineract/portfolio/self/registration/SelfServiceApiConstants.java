...
public class SelfServiceApiConstants {
	...
	public static final Set<String> REGISTRATION_REQUEST_DATA_PARAMETERS = new HashSet<>(
			Arrays.asList(usernameParamName, accountNumberParamName, passwordParamName, firstNameParamName,
...
//            passwordParamName, firstNameParamName,  lastNameParamName, emailParamName,authenticationModeParamName 
//            ,"agentIdType", "agentIdNumber", "agentCompanyName", "agentCompanyAddress", "agentDob", "contactNo", "agentBankName", "agentBankAccNo", "isAgreementsignup"
//            ,"faceId" ,"appId" ,"appName" ,"createdDate" ,"dateFormat" ,"imageEncryption" ,"image" ,"isActive" ,"locale","agentDeatils"
//           ));

	public static final Set<String> CREATE_USER_REQUEST_DATA_PARAMETERS = new HashSet<>(
			Arrays.asList(requestIdParamName, authenticationTokenParamName));
	...
	public static final String AGENT_USER_ROLE = "Agent User Role";
	public static final String DELEGATE_USER_ROLE = "Delegate User Role";
	public static final String CUSTOMER_USER_ROLE = "Customer User Role";
