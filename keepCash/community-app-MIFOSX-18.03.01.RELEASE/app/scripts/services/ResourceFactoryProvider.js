        ...
        ResourceFactoryProvider: function () {
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    clientAgentResource: defineResource(apiVer + "/clients/agents/:anotherresource", {clientId: '@clientId', anotherresource: '@anotherresource', sqlSearch: '@sqlSearch'}, {
                        getAllClients: {method: 'GET', params: {limit: 1000, sqlSearch: '@sqlSearch'}},
                        getAllClientsWithoutLimit: {method: 'GET', params: {}},
                        getClientClosureReasons: {method: 'GET', params: {}},
                        getAllClientDocuments: {method: 'GET', params: {}, isArray: true},
                    ...
                    clientCustomerResource: defineResource(apiVer + "/clients/customers/:anotherresource", {clientId: '@clientId', anotherresource: '@anotherresource', sqlSearch: '@sqlSearch'}, {
                        getAllClients: {method: 'GET', params: {limit: 1000, sqlSearch: '@sqlSearch'}},
                        getAllClientsWithoutLimit: {method: 'GET', params: {}},
                        getClientClosureReasons: {method: 'GET', params: {}},
                        getAllClientDocuments: {method: 'GET', params: {}, isArray: true},
                    ...
                    clientReceiptsResource: defineResource(apiVer + "/topup/:clientId/documents/:documentId", {clientId: '@clientId', documentId: '@documentId'}, {
                        getAllClientReceipt: {method: 'GET', params: {}, isArray: true}
                    }),
                    ...
                    agentEmployeeResource: defineResource(apiVer + "/staff/employee", {clientId: '@clientId',status:"all"}, {
                        getEmployeesUnderAgent: {method: 'GET', params: {clientId: '@clientId'}, isArray: true}
                    }),
                    ...
                    agentApprovalResource: defineResource(apiVer + "/makercheckers/makercheckersdeposit?actionName=TOPUP&entityName=AGENTSAVINGSACCOUNT:templateResource", {templateResource: '@templateResource'}, {
                        get: {method: 'GET', params: {}},
                        search: {method: 'GET', params: {}, isArray: true}
                    }),
                   ...
                   provisioningcriteria: defineResource(apiVer + "/provisioningcriteria/:criteriaId",{criteriaId:'@criteriaId'},{
                    ...
                    notificationsResource: defineResource(apiVer + "/notifications", {}, {
                        getAllNotifications: {method: 'GET', params: {}},
                        put: {method: 'PUT', params:{}}
                    }),
