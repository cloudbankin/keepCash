(function (module) {
    mifosX.controllers = _.extend(module, {
        AgentSearchTransactionController: function (scope, resourceFactory, paginatorService, dateFilter, location) {
            scope.filters = [
                {option: "All", value: ""},
            ...
            if(location.search().savingsId != null){
                ...
                scope.isCollapsed = false;
                scope.isValid = true;
                scope.path = "#/viewagentsavingaccount/" + scope.formData.savingsaccountId;
            }
        }
    });
    mifosX.ng.application.controller('AgentSearchTransactionController', ['$scope', 'ResourceFactory', 'PaginatorService', 'dateFilter', '$location', mifosX.controllers.AgentSearchTransactionController]).run(function ($log) {
        $log.info("AgentSearchTransactionController initialized");
    });
}(mifosX.controllers || {}));