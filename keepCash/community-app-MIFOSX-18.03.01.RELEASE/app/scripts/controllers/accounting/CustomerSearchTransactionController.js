(function (module) {
    mifosX.controllers = _.extend(module, {
        CustomerSearchTransactionController: function (scope, resourceFactory, paginatorService, dateFilter, location) {
            scope.filters = [
                {option: "All", value: ""},
            ...
            if(location.search().savingsId != null){
                ...
                scope.isCollapsed = false;
                scope.isValid = true;
                scope.path = "#/viewcustomersavingaccount/" + scope.formData.savingsaccountId;
            }
        }
    });
    mifosX.ng.application.controller('CustomerSearchTransactionController', ['$scope', 'ResourceFactory', 'PaginatorService', 'dateFilter', '$location', mifosX.controllers.CustomerSearchTransactionController]).run(function ($log) {
        $log.info("CustomerSearchTransactionController initialized");
    });
}(mifosX.controllers || {}));