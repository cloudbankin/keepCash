(function (module) {
    mifosX.controllers = _.extend(module, {
        ViewCustomerController: function (scope, routeParams, route, location, resourceFactory, http, $uibModal, API_VERSION, $rootScope, Upload) {
            scope.client = [];
           ...
           // scope.families=[];
            ...
            scope.routeToSaving = function (id, depositTypeCode) {
                if (depositTypeCode === "depositAccountType.savingsDeposit") {
                    location.path('/viewcustomersavingaccount/' + id);
    ...
    mifosX.ng.application.controller('ViewCustomerController', ['$scope', '$routeParams', '$route', '$location', 'ResourceFactory', '$http', '$uibModal', 'API_VERSION', '$rootScope', 'Upload', mifosX.controllers.ViewCustomerController]).run(function ($log) {
        $log.info("ViewCustomerController initialized");
    });
}(mifosX.controllers || {}));