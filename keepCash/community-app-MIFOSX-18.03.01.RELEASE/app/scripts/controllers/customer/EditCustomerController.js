(function (module) {
    mifosX.controllers = _.extend(module, {
        EditCustomerController: function (scope, routeParams, resourceFactory, location, http, dateFilter, API_VERSION, Upload, $rootScope) {
            scope.offices = [];
            scope.date = {};
            ...
            scope.submit = function () {
                ...
                resourceFactory.clientResource.update({'clientId': routeParams.id}, this.formData, function (data) {
                    location.path('/viewcustomer/' + routeParams.id);
                });
            };
        }
    });
    mifosX.ng.application.controller('EditCustomerController', ['$scope', '$routeParams', 'ResourceFactory', '$location', '$http', 'dateFilter', 'API_VERSION', 'Upload', '$rootScope', mifosX.controllers.EditCustomerController]).run(function ($log) {
        $log.info("EditCustomerController initialized");
    });
}(mifosX.controllers || {}));
