(function (module) {
    mifosX.controllers = _.extend(module, {
        TaskController: function (scope, resourceFactory, route, dateFilter, $uibModal, location) {
            ...
            scope.routeToAgent = function (id) {
                location.path('viewagentinbox/' + id);
            };
            ...
            resourceFactory.agentApprovalResource.search(function (data) {
                scope.groupedagents = data;
            });
            ...
            // resourceFactory.clientAgentResource.getAllClients({sqlSearch: 'c.status_enum=100'}, function (data) {
            //     scope.groupedagents = _.groupBy(data.pageItems, "officeName");
            // });
            ...
            scope.search = function () {
                ...
                resourceFactory.agentApprovalResource.search(params, function (data) {
                    scope.groupedagents = data;
                    if (scope.userTypeahead) {
                        scope.formData.user = '';
                        scope.userTypeahead = false;
