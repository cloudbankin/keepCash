(function (module) {
    mifosX.controllers = _.extend(module, {
        AgentSavingAccountActionsController: function (scope, rootScope, resourceFactory, location, routeParams, dateFilter) {
            ...
            scope.cancel = function () {
                location.path('/viewagentsavingaccount/' + routeParams.id);
            };
            ...
            scope.submit = function () {
                ...
                if (scope.action == "deposit" || scope.action == "withdrawal" || scope.action == "modifytransaction" || scope.action=="postInterestAsOn") {
                    ...
                    resourceFactory.savingsTrxnsResource.save(params, this.formData, function (data) {
                        location.path('/viewagentsavingaccount/' + data.savingsId);
                    });
    ...
    mifosX.ng.application.controller('AgentSavingAccountActionsController', ['$scope','$rootScope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', mifosX.controllers.AgentSavingAccountActionsController]).run(function ($log) {
        $log.info("AgentSavingAccountActionsController initialized");
    });
}(mifosX.controllers || {}));
