(function (module) {
    mifosX.controllers = _.extend(module, {
        CustomerSavingAccountActionsController: function (scope, rootScope, resourceFactory, location, routeParams, dateFilter) {
            ...
            scope.cancel = function () {
                location.path('/viewcustomersavingaccount/' + routeParams.id);
            };
            ...
            scope.submit = function () {
                ...
                if (scope.action == "deposit" || scope.action == "withdrawal" || scope.action == "modifytransaction" || scope.action=="postInterestAsOn") {
                    ...
                    resourceFactory.savingsTrxnsResource.save(params, this.formData, function (data) {
                        location.path('/viewcustomersavingaccount/' + data.savingsId);
                    });
    ...
    mifosX.ng.application.controller('CustomerSavingAccountActionsController', ['$scope','$rootScope', 'ResourceFactory', '$location', '$routeParams', 'dateFilter', mifosX.controllers.CustomerSavingAccountActionsController]).run(function ($log) {
        $log.info("CustomerSavingAccountActionsController initialized");
    });
}(mifosX.controllers || {}));
