(function (module) {
    mifosX.controllers = _.extend(module, {
        AgentController: function (scope, resourceFactory, location) {
            scope.clients = [];
            scope.actualClients = [];
            scope.searchText = "";
            scope.searchResults = [];
            ...
            scope.getResultsPage = function (pageNumber) {
                ...
                var items = resourceFactory.clientAgentResource.getAllClients({
            ...
            scope.initForAgentPage = function () {
            ...
            scope.search = function () {
                ...
                if(!scope.searchText){
                    ...
                    resourceFactory.globalSearch.search({query: searchString , resource: "agents,clientIdentifiers",exactMatch: exactMatch}, function (data) {
    ...
    mifosX.ng.application.controller('AgentController', ['$scope', 'ResourceFactory', '$location', mifosX.controllers.AgentController]).run(function ($log) {
