    ...
    var defineRoutes = function ($routeProvider, $locationProvider) {
        $routeProvider
            ...
            .when('/editcustomer/:id', {
                templateUrl: 'views/clients/editcustomer.html'
            })
            .when('/viewclient/:id', {
            ...
            .when('/viewcustomer/:id', {
                templateUrl: 'views/clients/viewcustomer.html'
            })
            ...
            .when('/addagentdocument/:clientId', {
                templateUrl: 'views/clients/addagentdocument.html'
            })
            ...
            .when('/addagentidentifier/:clientId', {
                templateUrl: 'views/clients/addagentidentifier.html'
            })
            .when('/addagentidentifierdocument/:clientId/:resourceId', {
                templateUrl: 'views/clients/addagentidentifierdocument.html'
            })
            ...
            .when('/viewemployeedetails/:id', {
                templateUrl: 'views/employee/viewemployeedetails.html'
            })
            ...
            .when('/agentsearchtransaction', {
                templateUrl: 'views/accounting/agent_search_transaction.html'
            })
            .when('/customersearchtransaction', {
                templateUrl: 'views/accounting/customer_search_transaction.html'
            })
            ...
            .when('/viewagentsavingaccount/:id', {
                templateUrl: 'views/savings/view_agent_saving_account_details.html'
            })
            .when('/viewcustomersavingaccount/:id', {
                templateUrl: 'views/savings/view_customer_saving_account_details.html'
            })
            ...
            .when('/agentsavingaccount/:id/:action', {
                templateUrl: 'views/savings/agent_saving_account_actions.html'
            })
            .when('/customersavingaccount/:id/:action', {
                templateUrl: 'views/savings/customer_saving_account_actions.html'
            })
            ...
            .when('/viewagentaccounttransfers/:id', {
                templateUrl: 'views/accounttransfers/view_agent_accounttransfer.html'
            })
            .when('/viewcustomeraccounttransfers/:id', {
                templateUrl: 'views/accounttransfers/view_customer_accounttransfer.html'
            })
            ...
            .when('/viewagentsavingtrxn/:accountId/trxnId/:id', {
                templateUrl: 'views/savings/view_agent_saving_transaction.html'
            })
            .when('/viewcustomersavingtrxn/:accountId/trxnId/:id', {
                templateUrl: 'views/savings/view_customer_saving_transaction.html'
            })
            ...
            .when('/viewagentinbox/:id', {
                templateUrl: 'views/system/viewAgentCheckerInbox.html'
            })
